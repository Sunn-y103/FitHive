...
const WaterIntakeSection: React.FC = () => {
  ...
  const getGraphData = (): { labels: string[]; values: number[] } => {
    ...
    if (activeTab === 'Today') {
      // Last 12 hours, grouped by 2-hour intervals
      ...
      // Monthly - last 30 days grouped into 7 points (approx 4-5 days each)
      const labels: string[] = [];
      const values: number[] = [];
      ...
      for (let i = 0; i < 7; i++) {
        ...
        values.push(periodTotal / daysPerGroup); // Average per day in period
      }
      ...
      <Svg width={GRAPH_WIDTH} height={GRAPH_HEIGHT}>
        <Defs>
          <LinearGradient id="areaGradient" x1="0" y1="0" x2="0" y2="1">
            <Stop offset="0%" stopColor="#A992F6" stopOpacity={0.4} />
            <Stop offset="100%" stopColor="#A992F6" stopOpacity={0.05} />
          </LinearGradient>
        </Defs>
      ...
      <View style={styles.headerRow}>
        <View style={styles.headerLeft}>
          ...
          <View>
            ...
            <Text style={styles.sectionSubtitle}>Track your hydration</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.recentCard}>
        ...
        {recentEntries.map((entry) => (
          <View key={entry.id} style={styles.entryItem}>
            ...
            <Ionicons name="water-outline" size={20} color="#A992F6" />
          </View>
        ))}
      </View>
    </View>
